...
---@field callback function Callback function to call when the toast hides
...
function Toast:setCallback(self, Callback) end
...
---@param self Toast self
---@return function nil Callback function to call when the toast hides
function Toast:getCallback(self) end
...
---@field items table of items in the collection.
...
---@param Items table of items in the collection.
...
function VisualElement:mouse_click() end
...
---Registers a function to handle the onDoubleClick event.
---@param self VisualElement self
---@param func function The function to be called when the event fires
function VisualElement:onOnDoubleClick(self, func) end
