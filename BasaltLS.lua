...
---@field tabScrollOffset number scroll offset for tabs in scrollable mode
---@field activeTab number currently active tab ID
---@field activeTabBackground color color for the active tab
---@field scrollableTab boolean scroll mode for tabs if they exceed width
...
---@return boolean Enables scroll mode for tabs if they exceed width
...
---@param self TabControl self
---@param ScrollableTab boolean scroll mode for tabs if they exceed width
...
---@param self TabControl self
---@param TabScrollOffset number scroll offset for tabs in scrollable mode
function TabControl:setTabScrollOffset(self, TabScrollOffset) end

---Gets the value of the TabScrollOffset property.
---@param self TabControl self
---@return number Current scroll offset for tabs in scrollable mode
